        ...
        <div className="aftershock-standby">
          ...
          <div className="aftershock-standby-copy">
            ...
            <p className="aftershock-standby-detail">
              ...
              automatically the moment a live mainshock crosses the trigger criteria shown in the header above,
              giving you a real-time chance to commit resilience budget to an emergency response before it locks
