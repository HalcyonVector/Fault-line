...
// Presets store a *manual override* snapshot of the resolved engine params so
// a user can recall a tension/timbre they liked instead of always following
// the live unrest index.
